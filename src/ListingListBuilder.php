...
/**
 * @file
 * Contains \Drupal\drealty\ListingListBuilder.
 */
...
/**
 * Defines a class to build a listing of listing entities.
 *
 * @see \Drupal\drealty\Entity\Listing
 */
class ListingListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new ListingListBuilder object.
   *
  ...
  public function buildRow(EntityInterface $entity) {
    ...
    $row['type'] = String::checkPlain(drealty_get_type_label($entity));
