...
/**
 * @file
 * Contains \Drupal\drealty\ListingTranslationHandler.
 */
...
/**
 * Defines the translation handler for listings.
 */
class ListingTranslationHandler extends ContentTranslationHandler {
  ...
  public function entityFormAlter(array &$form, FormStateInterface $form_state, EntityInterface $entity) {
    ...
    if (isset($form['content_translation'])) {
      $form['content_translation'] += array(
        '#group' => 'advanced',
        '#attributes' => array(
          'class' => array('listing-translation-options'),
        ),
      );

      $form['content_translation']['#weight'] = 100;

      // We do not need to show these values on listing forms: they inherit the
      // basic listing property values.
