/**
 * @file
 * Defines Javascript behaviors for drealty listings.
 */
...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.listingDetailsSummaries = {
    attach: function (context) {
      var $context = $(context);
      $context.find('.drealty-listing-form-revision-information').drupalSetSummary(function (context) {
        var $context = $(context);
      ...
      $context.find('.drealty-listing-form-author').drupalSetSummary(function (context) {
        var $context = $(context);
      ...
      $context.find('.drealty-listing-form-options').drupalSetSummary(function (context) {
        var $context = $(context);
        var vals = [];
      ...
      $context.find('fieldset.drealty-listing-translation-options').drupalSetSummary(function (context) {
        var $context = $(context);
        var translate;
